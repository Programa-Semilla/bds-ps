...
-- ActorRole captures who enqueued the job so the worker can recreate the same
-- bypass-attribution the sync controller path applies (FINDING-4 / FR-H1).
-- No default — every new job must specify Reviewer|Admin.
