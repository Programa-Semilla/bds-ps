...
resource script_sqlserver_fundingdb 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  name: take('script-${uniqueString('sqlserver', principalName, 'fundingdb', resourceGroup().id)}', 24)
  location: location
  identity: {
    type: 'UserAssigned'
