...
description: 'Triage PR review comments: autonomously handle bot suggestions, interactively
  review human comments'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: spex-collab:commands/speckit.spex-collab.triage.md
---
