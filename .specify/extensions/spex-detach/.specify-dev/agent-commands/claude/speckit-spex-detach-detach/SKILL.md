...
description: Create clean PR branch with spec artifacts stripped, or archive specs
  to project-specs repo
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: spex-detach:commands/speckit.spex-detach.detach.md
---
