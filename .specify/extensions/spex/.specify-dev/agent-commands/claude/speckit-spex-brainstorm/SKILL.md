---
name: speckit-spex-brainstorm
description: Refine rough ideas into executable specifications through collaborative
  questioning, alternative exploration, and incremental validation
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: spex:commands/speckit.spex.brainstorm.md
---
