...
description: Multi-perspective code review with autonomous fix loop - dispatches 5
  specialized review agents, merges findings, auto-fixes Critical/Important issues
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: spex-deep-review:commands/speckit.spex-deep-review.review.md
---
