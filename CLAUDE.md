...
<!-- SPECKIT START -->
Active plan: none in flight — **032-admin-user-code** implemented (see Recent Changes above) on branch `032-admin-user-code`. Filtered E2E green (RegistrationRemoved + AdminUserCode + UserCodeSearch + 3 rewired classes = 30/0); full E2E run for the cross-cutting `/Account/SeedUser` bootstrap change. Awaiting PR/merge.

Last shipped: **032-admin-user-code** (see Recent Changes above). Prior: **031-searchable-dropdowns** — filtered E2E green (SearchableDropdowns 7/7, SupplierLocationCascade 4/4, edited-view sweep 16/16), awaiting PR/merge. **030-edit-process-name** (full E2E 302/0/5, awaiting PR/merge).
<!-- SPECKIT END -->
