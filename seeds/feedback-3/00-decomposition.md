...
| **C** | Auditor workflow stage | §11, §12, §18, §19, §22.9/22.10/22.11, §23.1/23.2, §25.2/25.4, §28.9 | A | shipped → `specs/040-auditor-workflow-stage/` (co-shipped in PR #72) |
| **D** | Regulatory freshness gating + Hacienda API sync | §15.5, §16, §17, §25.3, §28.6/28.7 | A | shipped → `specs/043-regulatory-freshness-hacienda-sync/` (PR #75) |
| **E** | Fund process windows + applicant timing UX | §3, §22.1/22.2/22.2A, §24.1/24.2, §26.1–26.3, §28.11/28.12 | — (touches Process/Fund) | spec-created → `specs/044-process-reception-windows/` |
