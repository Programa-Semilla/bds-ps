...
|---|---|---|---|---|
| **A** | Provider compliance model + Auditor role (foundation) | §2.3, §9, §10 (10.1/10.1.1/10.3/10.4/10.5/10.5.1/10.6), §13, §15 (15.1–15.4, 15.6, 15.7), §22.5/22.6/22.11A, §23.1, §25.1, §28.4/28.5 | — | spec-created → `specs/038-auditor-provider-compliance/` |
| **B** | Supplier recommendation algorithm rewrite | §14, §22.7/22.8, §6 (item-line fields), §28.2/28.3 | A | not-started |
