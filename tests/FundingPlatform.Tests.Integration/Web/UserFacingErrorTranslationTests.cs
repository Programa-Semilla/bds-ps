...
internal static class SignedUploadEndpointsTestSeeder
{
            ...
            FundingPlatform.Infrastructure.Persistence.AppDbContext ctx)
    {
        ...
        var application = new FundingPlatform.Domain.Entities.Application(applicant.Id, 1, null,"Test Company");
        application.AssignPublicCode(FundingPlatform.Tests.Integration.Helpers.TestPublicCodes.Next());
        application.AddItem(new FundingPlatform.Domain.Entities.Item("Laptop", category.Id));
